...
##### 1706: Resume: RoA problem flashcards, tracking time.
...
60*53/116
```
53 minutes for 116 problems. 2.19 problems per minute, 27.4 seconds per problem.


##### 1759: Done typesetting 116 RoA problem flashcards, sans solutions. Checking work.

```{python }
116/21
60*21/116
```
21 minutes for 116 problems. 5.52 problems per minute, 10.9 seconds per problem.


##### 1820: Done checking 116 RoA sans solutions. Committing work.

```{python }
116/25
60*25/116
```
25 minutes for 116 problems. 4.64 problems per minute, 12.9 seconds per problem.


##### 1845: Done committing. Break.

##### 1851: Resume. Typeset RoA solutions.

```{python }
116/37
60*37/116
```
37 minutes for 116 problems. 3.14 problems per minute, 19.1 seconds per problem.


##### 1928: Done typesetting RoA solutions. Checking.
...
60*14/116
```
14 minutes for 116 problems. 8.29 problems per minute, 7.24 seconds per problem.


##### 1942: Done checking RoA solutions. Committing.

```{python }
116/18
60*18/116
```
18 minutes for 116 problems. 6.44 problems per minute, 9.31 seconds per problem.


##### 2000: Done committing RoA solutions. Computing edit rates.
...
Totals:
- 2h48m (168m) for 116 problems.
- 0.69 problems per minute.
- 1.44 minutes per problem.
